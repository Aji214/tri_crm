                    ...
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="number" name="hpp" id="hpp" class="block w-full rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="0" required value="{{ old('hpp') }}">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex mt-1">
                                <input type="number" step="0.01" name="margin" id="margin" class="block w-full rounded-none rounded-l-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="0" required value="{{ old('margin') }}">
